...
const tickerMessages=[["LIVE","MetaApi MT5 market connection"],["MT5","Account data is loaded only after broker authentication"],["MARKET","Prices come from the connected MT5 broker"],["XAU","Gold symbol is selected from the broker’s real symbols"],["SECURE","MetaApi token stays on the server"],["STATUS","No fake balance or fake broker connection"]];
